...
const FacebookIcon = () => (
  <a
    ...
    target="_blank"
    rel="noreferrer"
    className={clsx("fill-amber-900", "sm:hover:fill-white")}
  >
...
function MobileBottomBar() {
  return (
    <aside className={clsx("fixed inset-0 top-auto h-14 bg-background", "sm:hidden")}>
      ...
      <aside className={clsx("hidden fixed bottom-0 left-20", "sm:block")}>
        <div className="flex flex-col items-center">
          <ul className="mb-10 flex flex-col items-center gap-6 ">
            <li onMouseEnter={() => absorbColorToBg("bg-amber-900")} onMouseLeave={resetBg}>
              <GithubIcon />
            </li>
            <li onMouseEnter={() => absorbColorToBg("bg-amber-900")} onMouseLeave={resetBg}>
              <FacebookIcon />
