...
const FacebookIcon = () => (
  <a
    ...
    target="_blank"
    rel="noreferrer"
    className={clsx("fill-emerald-500", "lg:hover:fill-background")}
  >
...
function BelowLgBottomBar({ liProps }: { liProps: any }) {
  return (
    <aside className={clsx("fixed inset-0 top-auto h-14 bg-background", "lg:hidden", "dark:bg-zinc-900")}>
...
export default function SideBar() {
  ...
  return (
    <>
      <BelowLgBottomBar liProps={liProps} />
      <AboveLgSideBar liProps={liProps} />
    </>
  );
}
