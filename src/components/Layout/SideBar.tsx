...
const GithubIcon = () => (
  <a
    ...
    target="_blank"
    rel="noreferrer"
    className={clsx("fill-emerald-500", "sm:hover:fill-white")}
  >
...
function MobileBottomBar() {
  return (
    <aside className={clsx("fixed inset-0 top-auto h-14 bg-background", "sm:hidden", "dark:bg-zinc-900")}>
...
export default function SideBar() {
  ...
  return (
    <>
      <MobileBottomBar />
      <aside className={clsx("hidden fixed bottom-0 left-20", "sm:block")}>
        <div className="flex flex-col items-center">
          <ul className="mb-10 flex flex-col items-center gap-6">
            <li onMouseEnter={() => absorbColorToBg("bg-emerald-500")} onMouseLeave={resetBg}>
              <GithubIcon />
            </li>
            <li onMouseEnter={() => absorbColorToBg("bg-emerald-500")} onMouseLeave={resetBg}>
              <FacebookIcon />
